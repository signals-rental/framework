<div class="flex items-center gap-1">
    <a href="{{ route('product-groups.show', $row->id) }}" wire:navigate class="s-btn s-btn-xs s-btn-ghost" title="View">
    ...
    <a href="{{ route('product-groups.edit', $row->id) }}" wire:navigate class="s-btn s-btn-xs s-btn-ghost" title="Edit">
    ...
    <button wire:click="$parent.deleteGroup({{ $row->id }})" wire:confirm="Delete this product group?" class="s-btn s-btn-xs s-btn-ghost s-btn-danger" title="Delete">
