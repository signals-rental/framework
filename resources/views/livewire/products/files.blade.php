...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    {
        $this->product->loadCount('attachments');
    }
...
<section class="w-full">
    ...
    <div class="flex-1 px-6 py-4 max-md:px-5 max-sm:px-3">
        ...
        @if($totalCount === 0)
            <x-signals.empty title="No Files" description="Upload files to keep documents, images, and other files organised for this product.">
                <x-slot:icon>
