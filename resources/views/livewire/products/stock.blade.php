    ...
    public function with(): array
    {
        return [
            'columns' => [
                ...
                ['key' => 'quantity_held', 'label' => 'Held', 'sortable' => true, 'view' => 'livewire.stock-levels.partials.column-quantity-held'],
                ['key' => 'quantity_allocated', 'label' => 'Allocated', 'sortable' => true, 'view' => 'livewire.stock-levels.partials.column-quantity-allocated'],
                ['key' => 'quantity_unavailable', 'label' => 'Unavailable', 'sortable' => true, 'view' => 'livewire.stock-levels.partials.column-quantity-unavailable'],
