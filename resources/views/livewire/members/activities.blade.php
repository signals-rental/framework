...
<section class="w-full">
    ...
    <div class="flex-1 px-6 py-4 max-md:px-5 max-sm:px-3">
        <x-signals.empty title="Activities Coming Soon" description="Activity logs and interactions for this member will appear here.">
            <x-slot:icon>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="w-10 h-10 opacity-30"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            </x-slot:icon>
        </x-signals.empty>
    </div>
</section>
