...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <style>
            ...
            .dark .signals-logo-mark { color: white; }
            ...
            .dark .signals-auth-footer-text { color: #94a3b8; }
            ...
            .dark .signals-auth-footer a { color: #94a3b8; }
            .signals-auth-footer a:hover { color: #0f172a; }
            .dark .signals-auth-footer a:hover { color: #ffffff; }
        ...
        <div class="flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            <div class="flex w-full max-w-md flex-col gap-6">
                ...
                <div class="flex flex-col gap-6">
                    <div class="signals-form-card shadow-xs">
