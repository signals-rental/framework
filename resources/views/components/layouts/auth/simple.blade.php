...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <style>
            ...
            .signals-logo-mark.size-sm {
                font-size: 0.75rem;
                padding: 4px 10px;
            }
            .signals-logo-mark.size-sm::after {
                width: 5px;
                height: 5px;
            }
            ...
            .dark .signals-auth-footer a {
                color: #94a3b8;
            }
            .signals-auth-footer a:hover {
                color: #0f172a;
            }
            .dark .signals-auth-footer a:hover {
                color: #ffffff;
            }
