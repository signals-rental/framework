...
class OpportunityVersionColumnRegistry extends ColumnRegistry
{
    ...
    protected function columns(): array
    {
        return [
            ...
            Column::make('sent_to')->label('Sent To')->filterable()->type('relation'),
            Column::make('sent_via')->label('Sent Via')->sortable()->filterable(),
            Column::make('accepted_by')->label('Accepted By')->filterable()->type('relation'),
            Column::make('decline_reason')->label('Decline Reason')->filterable(),
            ...
            Column::make('declined_at')->label('Declined')->sortable()->filterable()->type('datetime'),
