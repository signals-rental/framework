...
class OpportunityColumnRegistry extends ColumnRegistry
{
    ...
    protected function columns(): array
    {
        return [
            ...
            Column::make('charge_starts_at')->label('Charge Starts')->sortable()->filterable()->type('datetime'),
            Column::make('charge_ends_at')->label('Charge Ends')->sortable()->filterable()->type('datetime'),
            ...
            Column::make('has_shortage')->label('Has Shortage')->sortable()->filterable()->type('boolean'),
            Column::make('tag_list')->label('Tags')->filterable()->type('json'),
            Column::make('version_count')->label('Version Count')->sortable()->type('integer'),
            Column::make('active_version_id')->label('Active Version')->type('integer'),
