...
class OpportunityData extends Data
{
    ...
    public function __construct(
        ...
        public ?string $prep_starts_at,
        public ?string $prep_ends_at,
        public ?string $load_starts_at,
        public ?string $load_ends_at,
        public ?string $deliver_starts_at,
        public ?string $deliver_ends_at,
        public ?string $setup_starts_at,
        public ?string $setup_ends_at,
        public ?string $show_starts_at,
        public ?string $show_ends_at,
        public ?string $takedown_starts_at,
        public ?string $takedown_ends_at,
        public ?string $collect_starts_at,
        public ?string $collect_ends_at,
        public ?string $unload_starts_at,
        public ?string $unload_ends_at,
        public ?string $deprep_starts_at,
        public ?string $deprep_ends_at,
        public ?string $ordered_at,
        public ?string $quote_invalid_at,
        public bool $use_chargeable_days,
        public ?string $chargeable_days,
        public bool $open_ended_rental,
        public bool $customer_collecting,
    ...
    public static function fromModel(Opportunity $opportunity): self
    {
        ...
        return new self(
            ...
            state_name: $opportunity->state->label(),
            ...
            prep_starts_at: self::formatNullableTimestamp($opportunity->prep_starts_at),
            prep_ends_at: self::formatNullableTimestamp($opportunity->prep_ends_at),
            load_starts_at: self::formatNullableTimestamp($opportunity->load_starts_at),
            load_ends_at: self::formatNullableTimestamp($opportunity->load_ends_at),
            deliver_starts_at: self::formatNullableTimestamp($opportunity->deliver_starts_at),
            deliver_ends_at: self::formatNullableTimestamp($opportunity->deliver_ends_at),
            setup_starts_at: self::formatNullableTimestamp($opportunity->setup_starts_at),
            setup_ends_at: self::formatNullableTimestamp($opportunity->setup_ends_at),
            show_starts_at: self::formatNullableTimestamp($opportunity->show_starts_at),
            show_ends_at: self::formatNullableTimestamp($opportunity->show_ends_at),
            takedown_starts_at: self::formatNullableTimestamp($opportunity->takedown_starts_at),
            takedown_ends_at: self::formatNullableTimestamp($opportunity->takedown_ends_at),
            collect_starts_at: self::formatNullableTimestamp($opportunity->collect_starts_at),
            collect_ends_at: self::formatNullableTimestamp($opportunity->collect_ends_at),
            unload_starts_at: self::formatNullableTimestamp($opportunity->unload_starts_at),
            unload_ends_at: self::formatNullableTimestamp($opportunity->unload_ends_at),
            deprep_starts_at: self::formatNullableTimestamp($opportunity->deprep_starts_at),
            deprep_ends_at: self::formatNullableTimestamp($opportunity->deprep_ends_at),
            ordered_at: self::formatNullableTimestamp($opportunity->ordered_at),
            quote_invalid_at: self::formatNullableTimestamp($opportunity->quote_invalid_at),
            use_chargeable_days: (bool) $opportunity->use_chargeable_days,
            chargeable_days: $opportunity->chargeable_days !== null ? (string) $opportunity->chargeable_days : null,
            open_ended_rental: (bool) $opportunity->open_ended_rental,
            customer_collecting: (bool) $opportunity->customer_collecting,
            ...
            pricing_locked: $opportunity->pricingLocked(),
