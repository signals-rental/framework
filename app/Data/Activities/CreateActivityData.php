...
class CreateActivityData extends Data
{
    ...
    public function __construct(
        ...
        public int $priority = ActivityPriority::Normal->value,
        public int $type_id = ActivityType::Task->value,
        public int $status_id = ActivityStatus::Scheduled->value,
        public bool $completed = false,
        public int $time_status = TimeStatus::Free->value,
