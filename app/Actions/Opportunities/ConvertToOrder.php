 ...
 *
 * The quote → order transition runs through the {@see ShortageConfirmationGate}
 * first (shortage-resolution-sub-hires.md §7). The gate is a config-driven
 ...
 * proceeds. The gate runs inside the same atomic transaction as the event so an
 * acknowledgement and the conversion commit or roll back together.
 */
