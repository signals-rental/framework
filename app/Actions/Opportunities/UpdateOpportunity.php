...
class UpdateOpportunity
{
     ...
     */
    private const OPTIONAL_FIELDS = ['venue_id', 'reference', 'description', 'external_description'];
     ...
     */
    private const NULLABLE_FIELDS = ['subject', 'member_id', 'store_id', 'owned_by', 'starts_at', 'ends_at'];
